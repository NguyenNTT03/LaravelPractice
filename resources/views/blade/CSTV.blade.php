...
<div class="content">
    <div class="content_CSTV">
        ...
        Khách hàng đăng ký thẻ thành viên tại các cơ sở cửa hàng của Northside Crew trên toàn quốc với điều kiện hóa
        đơn trên 500.000VNĐ<br><br>
        ...
        Mỗi lần thanh toán khách hàng sẽ được cộng số điểm tương ứng với giá trị đơn hàng. Khi tích đủ điểm, quý
        khách tự động được thăng hạng trong hệ thống và được nhân viên thông báo để đổi thẻ mới. <br><br>
    </div>
</div>
@endsection
